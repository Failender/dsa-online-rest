...
@Component
public class LatestHeldenForGruppePublicActiveSupplier extends ScriptSupplier<List<Daten>> {

	public static final String TYPE = "latestheldenforgruppepublicactive";
	...
	public List<Daten> supply(String value) {
		return heldenService.findPublicActiveByGruppeId(Integer.valueOf(value));
	}
	...
	public String description() {
		return "Holt die neusten Versionen aller öffentlichen aktiven Helden einer Gruppe. Parameter ist die ID der Gruppe";
	}
